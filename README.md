...
- **Physique-Chimie** : Numérisation, Signaux, SNR.
- **Culture Générale** : Méthodologie, Thème "Le vrai du faux" (2027).
- **Blocs Pro** : Architecture (B1), Systèmes (B2), Admin Linux (B3), Réseaux (C1), IoT & Supervision (E4), Sécurité (F1).
